...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> medVerse </h2></br>
...
.content {
  ...
  <body style="padding-top:50px;">
   ...
   <h1 style = "margin-left: 35%; padding-bottom: 20px;font-family:'Poppins', sans-serif; font-weight:bold;font-size:xxx-large;">&nbsp&nbsp&nbsp&nbspWelcome&nbsp<?php echo $username ?></h3>
        ...
        <header>
            <div class="image-text">
                ...
                <div class="text logo-text">
                    <span class="name">User Portal</span>
                </div>
            </div>
        ...
        <div class="menu-bar">
            <div class="menu">
              <!-- <li class="search-box">
                    ...
                    <form class="form-inline my-2 my-lg-0" method="post" action="doctorsearch.php">
                ...
                <li class="search-box">
                <a  id="list-dash-list" data-toggle="list" href="#list-dash" role="tab" aria-controls="home">
              ...
              <li class="search-box">
               <a  id="list-home-list" data-toggle="list" href="#list-home" role="tab" aria-controls="home">
              ...
              <li class="search-box">
                <a  href="#app-hist" id="list-pat-list" role="tab" data-toggle="list" aria-controls="home">
  ...
  <div class="col-md-8" style="margin-top: 3%;">
    <div class="tab-content" id="nav-tabContent" style="width: 950px;">
        ...
        <div class="container-fluid container-fullw bg-black" >
              <div class="row">
               <div class="col-sm-4" style="left: 25%">
                ...
                <div class="col-sm-4" style="left: 43%;margin-top:5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
      ...
      <div class="tab-pane fade" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
        ...
        <div class="col-sm-9" style="left: 25%">
          <div class="card">
            <div class="card-body">
              ...
              <a href="payment.html">
                    <input type="submit" name="payment" value="Pay" class="btn btn-primary" id="inputbtn">
            </a>
            </div>
          </div>
        </div><br>
...
<!--PRESCRIPTION-->
      ...
      <div class="col-sm-9" style="left: 17%">
              <table class="table table-hover">
                <thead>
                  <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <!-- <a href="admin-panel.php?ID=" 
                              ...
                              <input type = "submit"  name ="generate_bill" class = "btn btn-success" value="View"/>
                              </a>
                              </td>
                              </form>
